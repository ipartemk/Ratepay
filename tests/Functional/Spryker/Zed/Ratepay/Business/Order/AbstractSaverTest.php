...
abstract class AbstractSaverTest extends Test
{
    ...
    public function setUp()
    {
        ...
        $this->quoteTransfer = $this->getQuoteTransfer($checkoutResponseTransfer);
        $paymentMapper = $this->getPaymentMapper();

        $orderManager = new Saver($this->getRatepayBusinessBusinessFactory());

        $orderManager->saveOrderPayment($this->quoteTransfer, $checkoutResponseTransfer, $paymentMapper);
     ...
     */
    protected function getQuoteTransfer($checkoutResponseTransfer)
    {
